...
export const metadata: Metadata = {
    ...
    icons: {
        apple: [
            { url: "https://assets.peur-de-la-conduite.fr/img/favicon/logo.svg", sizes: "152x152", type: "image/png" },  // iPad
            { url: "https://assets.peur-de-la-conduite.fr/img/favicon/logo.svg", sizes: "180x180", type: "image/png" },  // Retina
            { url: "https://assets.peur-de-la-conduite.fr/img/favicon/apple-touch-icon.png" },  // 120x120
        ],

        icon : [
            { url: "https://assets.peur-de-la-conduite.fr/img/favicon/logo.svg", type: "image/svg+xml" },
            { url: "https://assets.peur-de-la-conduite.fr/img/favicon/favicon-16x16.png", sizes: "16x16", type: "image/png" },  
            { url: "https://assets.peur-de-la-conduite.fr/img/favicon/icons/favicon-32x32.png", sizes: "32x32", type: "image/png" },  
            { url: "https://assets.peur-de-la-conduite.fr/img/favicon/icons/android-chrome-192x192.png", sizes: "192x192", type: "image/png" },  
            { url: "https://assets.peur-de-la-conduite.fr/img/favicon/icons/android-chrome-512x512.png", sizes: "512x512", type: "image/png" }, 
            { url: "https://assets.peur-de-la-conduite.fr/img/favicon/logo.svg", sizes: "48x48", type: "image/svg+xml" },  
            { url: "https://assets.peur-de-la-conduite.fr/img/favicon/logo.svg", sizes: "64x64", type: "image/svg+xml" }, 
            { url: "https://assets.peur-de-la-conduite.fr/img/favicon/logo.svg", sizes: "270x270", type: "image/svg+xml"  },  
            { url: "https://assets.peur-de-la-conduite.fr/img/favicon/logo.svg", sizes: "310x310", type: "image/svg+xml"  }, 
            { url: "https://assets.peur-de-la-conduite.fr/img/favicon/logo.svg", sizes: "152x152", type: "image/svg+xml"  },  
            { url: "https://assets.peur-de-la-conduite.fr/img/favicon/logo.svg", sizes: "180x180", type: "image/svg+xml" }, 
        ],        
    },
    alternates: {
    ...
    return (
        <html lang="fr-FR">
           <head>
                ...
                <link rel="preload" href="https://assets.peur-de-la-conduite.fr/img/retroviseur.svg" as="image" />
                <link
                    rel="stylesheet"
